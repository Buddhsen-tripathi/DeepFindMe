...
export default function NavBar() {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled || isOpen ? 'bg-gray-900 bg-opacity-90 backdrop-blur-md' : 'bg-transparent'}`}>
      ...
      {/* Mobile menu */}
      {isOpen && (
        <div className="md:hidden mt-4 bg-black bg-opacity-90 backdrop-blur-md">
          <div className="container mx-auto px-4 py-2">
