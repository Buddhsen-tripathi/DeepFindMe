...
export default function PlatinumContributorPage() {
        ...
        <main className='flex flex-col h-screen'>
            ...
            <div className="flex-grow bg-gray-900 text-white py-24">
                <div className="container mx-auto px-4 max-w-md">
                    <h1 className="text-4xl font-bold mb-8 text-center">Platinum Contributor</h1>
                    <p className="text-xl mb-8 text-center text-gray-300">
                        Thank you for choosing to become a Platinum Contributor! Your generous support helps us make significant improvements to our platform.
                    </p>
